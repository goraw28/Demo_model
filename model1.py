...
#     # df = pd.read_csv('C:\\Users\\GauravUgale\\Desktop\\ML_projects\\File_Names.csv')
...
#     # for filename in glob.glob("C:\\Users\\GauravUgale\\Desktop\\ML_projects\\All_files_check\\*"):
...
if __name__=="__main__":
    ...
    path = "C:\\Users\\GauravUgale\\Downloads\\csv_500\\csv_500\\"
    ...
    pd.DataFrame(all_vals[1:], columns=columns).to_csv('all_signal_data1.csv', index=False)